...
- Add persistent remote sessions, safe upload approval, checked patch apply, previews, dashboard, and explicit deletion.
- Bind approval to the exact Blaxel workspace, runtime settings, upload policy, and file digest.
